...
const HistoryPill = () => {
    return (
        <div className="col-span-1 flex justify-start items-center">
            <div className="inline-flex items-center rounded-full background-blur-xl bg-white/[0.08] border border-white/[0.12] p-2 text-neutral-300 saturate-150 " aria-hidden>
